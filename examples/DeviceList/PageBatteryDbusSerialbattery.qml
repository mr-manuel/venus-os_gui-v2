...
CustomDevicePageEntry {
	...
	title: qsTrId("dbus-serialbattery_general_title")
	...
	GradientListView {
		model: VisibleItemModel {
			ListItem {
				id: cellOverviewItem
				//% "Overview"
				text: qsTrId("dbus-serialbattery_general_overview")
				content.children: [
					Row {
						...
						Column {
							...
							Label {
								...
								//% "Current"
								text: qsTrId("dbus-serialbattery_general_current")
						...
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Current avg"
								text: qsTrId("dbus-serialbattery_general_current_avg")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Voltage"
								text: qsTrId("dbus-serialbattery_general_voltage")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Cell max"
								text: qsTrId("dbus-serialbattery_general_cell_max")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Cell min"
								text: qsTrId("dbus-serialbattery_general_cell_min")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "SoC"
								text: qsTrId("dbus-serialbattery_general_soc")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
					...
					Row {
						...
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Battery"
								text: qsTrId("dbus-serialbattery_general_battery")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "MOSFET"
								text: qsTrId("dbus-serialbattery_general_mosfet")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Temp 1"
								text: temperature1NameItem.value ?? qsTrId("dbus-serialbattery_general_temp1")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Temp 2"
								text: temperature2NameItem.value ?? qsTrId("dbus-serialbattery_general_temp2")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Temp 3"
								text: temperature3NameItem.value ?? qsTrId("dbus-serialbattery_general_temp3")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								horizontalAlignment: Text.AlignHCenter
								//% "Temp 4"
								text: temperature4NameItem.value ?? qsTrId("dbus-serialbattery_general_temp4")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
			...
			ListText {
				//% "Charge Mode"
				text: qsTrId("dbus-serialbattery_general_charge_mode")
			...
			ListItem {
				...
				//% "Allow to"
				text: qsTrId("dbus-serialbattery_general_allow_to")
					...
					Row {
						...
						Column {
							...
							Label {
								...
								//: Allow to ...
								//% "Charge"
								text: qsTrId("dbus-serialbattery_general_charge")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								//: Allow to ...
								//% "Discharge"
								text: qsTrId("dbus-serialbattery_general_discharge")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
						Column {
							...
							Label {
								...
								//: Allow to ...
								//% "Balance"
								text: qsTrId("dbus-serialbattery_general_balance")
								color: Theme.color_font_secondary
								font.pixelSize: Theme.font_size_caption
							}
						}
			...
			ListText {
				//% "Alarms"
				text: qsTrId("dbus-serialbattery_general_alarms")
			...
			SettingsListHeader {
				//% "Support"
				text: qsTrId("dbus-serialbattery_general_support")
			...
			ListLink {
				//% "How to troubleshoot"
				text: qsTrId("dbus-serialbattery_general_how_to_troubleshoot")
			...
			ListLink {
				...
				text: qsTrId("dbus-serialbattery_general_faq")
			...
			ListLink {
				//% "GitHub"
				text: qsTrId("dbus-serialbattery_general_github")
			...
			ListLink {
				...
				text: qsTrId("dbus-serialbattery_general_donate")
			...
			SettingsListHeader {
				//% "Driver Debug Data"
				text: qsTrId("dbus-serialbattery_general_driver_debug_data")
				preferredVisible: chargeModeDebug.valid && chargeModeDebug.value !== ""
			}

			ListItem {
				//% "General Values"
				text: qsTrId("dbus-serialbattery_general_values")
			...
			ListItem {
				...
				text: qsTrId("dbus-serialbattery_general_switch_to_float_requirements")
			...
			ListItem {
				...
				text: qsTrId("dbus-serialbattery_general_switch_to_bulk_requirements")

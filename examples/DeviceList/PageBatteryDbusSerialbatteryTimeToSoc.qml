...
CustomDevicePageEntry {
	...
	title: qsTrId("dbus-serialbattery_time_to_soc_title")
	...
	GradientListView {
		...
		VisibleItemModel {
			...
			ListItem {
				...
				text: qsTrId("dbus-serialbattery_time_to_soc_not_available")
			}
		}
		...
		VisibleItemModel {
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("0")
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("5")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("10")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("15")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("20")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("25")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("30")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("35")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("40")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("45")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("50")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("55")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("60")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("65")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("70")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("75")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("80")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("85")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("90")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("95")
				preferredVisible: dataItem.seen
			...
			ListText {
				//% "Time-to-SoC %1%"
				text: qsTrId("dbus-serialbattery_time_to_soc").arg("100")
				preferredVisible: dataItem.seen

...
CustomDevicePageEntry {
	...
	title: qsTrId("dbus-serialbattery_settings_title")
	...
	GradientListView {
		model: VisibleItemModel {
			...
			SettingsListHeader {
				//% "IO"
				text: qsTrId("dbus-serialbattery_settings_io")
			}
			...
			ListText {
				//% "Allow to balance"
				text: qsTrId("dbus-serialbattery_settings_allow_to_balance")
			...
			ListSwitch {
				//% "Force charging off"
				text: qsTrId("dbus-serialbattery_settings_force_charging_off")
			...
			ListSwitch {
				...
				text: qsTrId("dbus-serialbattery_settings_force_discharging_off")
			...
			ListSwitch {
				//% "Turn balancing off"
				text: qsTrId("dbus-serialbattery_settings_turn_balancing_off")
			...
			SettingsListHeader {
				//% "Settings"
				text: qsTrId("dbus-serialbattery_settings_settings")
			...
			ListSpinBox {
				...
				//% "Reset SoC to"
				text: qsTrId("dbus-serialbattery_settings_reset_soc_to")
